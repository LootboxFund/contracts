...
contract ContractA is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialMint(address _addressAlpha, address _addressBravo) public onlyRole(DEVELOPER_ROLE) {
